...
| F7 | Profil eigen (§13) | Tabs „Meine Rezepte" · „Gespeichert" | **Dritter Tab „Einstellungen"** | Die Seite trug bereits die komplette Kontoverwaltung (Daten, Passwort, Erscheinungsbild, freigegebene Rezepte, Konto löschen). Sie bleibt vollständig erhalten und zieht in einen eigenen Tab. **→ ersetzt durch F11** |
...
| F10 | Neues Rezept (§05) | Feinschliff: Pflicht sind Zeiten/Portionen/Art/Gang, **Schwierigkeit steht unter dem OPTIONAL-Trenner** | **Schwierigkeit ist Pflicht** fürs Veröffentlichen. Zusätzlich verlangt das Gate **mindestens eine Zutat** und **mindestens einen Zubereitungsschritt mit ≥30 Zeichen**. Das Feld startet dafür **ohne Vorbelegung** (vorher still auf „Mittel“) — sonst wäre die Pflicht eine Attrappe | Lead-Entscheidung (FR-Wizard-Gates, Ü13). Ein veröffentlichtes Rezept ohne Zutat, ohne echten Schritt oder ohne Schwierigkeit ist in der Suche und im Fratcher wertlos. Die **Navigation zwischen den Wizard-Schritten bleibt frei** — gesperrt ist nur das Veröffentlichen, damit das Bearbeiten von Bestandsrezepten nicht blockiert |
| F11 | Profil eigen (§13) | (ersetzt F7) | **Konto-/Einstellungen ziehen aus dem Profil-Tab (F7) in eine eigene Seite unter »Mehr«.** Das Profil zeigt nur noch Identität + eigene Inhalte: Tabs „Meine Rezepte" · „Merkliste" (Favoriten, Sammlungen, **für mich freigegebene Rezepte**) · „Beiträge" (verlinkte TT/Insta, F5). Neu im Kopf: **Vorlieben** (Freitext), sichtbar nur bei freigegebenem Toggle. Die **Freigaben eigener Rezepte** bleiben je Rezept im Bearbeiten-Modus der Rezept-Liste | Lead-Entscheidung (BUG-41). Revert von F7, zurück zur SPEC-§3-Nav-Absicht (Verwaltung ≠ Profil). „Für mich freigegeben" ist Inhalt, kein Konto-Setting, daher Merkliste statt Einstellungen |
