    ...
    <div ref={ref} style={{ position: 'relative' }}>
      ...
      {open && (
        <div style={{ position: 'absolute', right: 0, top: 44, background: 'var(--card)', boxShadow: 'var(--shadow-hover)', borderRadius: 10, padding: '0.375rem', minWidth: 180, zIndex: 200 }}>
          ...
          {/* „Mein Profil" → /profile ist seit dem IA-Umbau redundant zum
              „Mein Kochbuch"-Slot in der BottomNav. Das Avatar-Menü ist reines
              Konto; Profil bearbeiten passiert in den Einstellungen. */}
