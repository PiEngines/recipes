          ...
          <div style={{ display: 'flex', gap: '3px', alignItems: 'center' }}>
            {Array.from({ length: 10 }).map((_, i) => (
              <span key={i} style={{
                ...
                height: '7px',
                borderRadius: '50%',
                background: i < recipe.difficulty ? color : 'var(--border-input)',
...
function SkeletonCard() {
  return (
    <div className="recipe-card skeleton">
      ...
      <div style={{ padding: '1rem' }}>
        <div className="skeleton-block" style={{ height: '1.1rem', width: '80%', marginBottom: '0.75rem' }} />
        <div className="skeleton-block" style={{ height: '0.875rem', width: '55%', marginBottom: '0.75rem' }} />
        <div className="skeleton-block" style={{ height: '0.75rem', width: '65%' }} />
      </div>
    </div>
  )
}
  ...
  return (
    <button
      ...
      style={{
        ...
        color: disabled ? 'var(--subtext)' : 'var(--text)',
          ...
          <div ref={menuRef} style={{ position: 'relative' }}>
            ...
            {showMenu && (
              <div style={{
                ...
                <UserMenuItem onClick={() => { setShowMenu(false); logout() }}>
                  Abmelden
                </UserMenuItem>
              </div>
            )}
      ...
      <main style={{ maxWidth: '1200px', margin: '0 auto', padding: '2rem 1.5rem' }}>
        ...
        {!loading && totalPages > 1 && (
          <div style={{
            ...
            <span style={{ color: 'var(--subtext)', fontSize: '0.9rem', whiteSpace: 'nowrap' }}>
